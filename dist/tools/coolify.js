...
const client = () => createClient(`${config.coolify.url}/api/v1`, {
...
export async function handleCoolifyTool(name, args) {
    const http = client();
    switch (name) {
        ...
        case 'coolify_deploy_service': {
            ...
            const res = await safeRequest(() => http.post(`/applications/${args.uuid}/deploy`, payload).then(r => r.data));
            return toText(res);
        }
        case 'coolify_restart_service': {
            const res = await safeRequest(() => http.post(`/applications/${args.uuid}/restart`).then(r => r.data));
            return toText(res);
        }
        case 'coolify_stop_service': {
            const res = await safeRequest(() => http.post(`/applications/${args.uuid}/stop`).then(r => r.data));
            return toText(res);
        }
        case 'coolify_start_service': {
            const res = await safeRequest(() => http.post(`/applications/${args.uuid}/start`).then(r => r.data));
            return toText(res);
        }
        case 'coolify_list_envs': {
            const res = await safeRequest(() => http.get(`/applications/${args.uuid}/envs`).then(r => r.data));
            return toText(res);
        }
        case 'coolify_update_env': {
            ...
            const res = await safeRequest(() => http.post(`/applications/${args.uuid}/envs`, payload).then(r => r.data));
            return toText(res);
        }
        case 'coolify_update_envs_bulk': {
            const res = await safeRequest(() => http.patch(`/applications/${args.uuid}/envs/bulk`, { data: args.envs }).then(r => r.data));
            return toText(res);
        }
        case 'coolify_list_deployments': {
            const res = await safeRequest(() => http.get(`/applications/${args.uuid}/deployments`).then(r => r.data));
            return toText(res);
        }
        case 'coolify_get_deployment_logs': {
            const res = await safeRequest(() => http.get(`/deployments/${args.deployment_uuid}`).then(r => r.data));
            return toText(res);
        }
        ...
        case 'coolify_server_resources': {
            const res = await safeRequest(() => http.get(`/servers/${args.server_uuid}/resources`).then(r => r.data));
            return toText(res);
        }
        default:
