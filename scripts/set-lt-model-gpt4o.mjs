...
const upd=await tool('mongo_update',{database:'vendly',collection:'businesses',filter:{instances:'livraison-totale'},update:{$set:{'settings.model':'openai/gpt-4o-mini'}}});
console.log('upd:',upd);
